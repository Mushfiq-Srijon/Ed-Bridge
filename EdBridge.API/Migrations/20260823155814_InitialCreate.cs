        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AskingPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ListingSubjectTag",
                columns: table => new
                {
                    ListingId = table.Column<int>(type: "int", nullable: false),
                    SubjectTagId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingSubjectTag", x => new { x.ListingId, x.SubjectTagId });
                    table.ForeignKey(
                        name: "FK_ListingSubjectTag_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListingSubjectTag_SubjectTags_SubjectTagId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoteSubjectTag", x => new { x.NoteId, x.SubjectTagId });
                    table.ForeignKey(
                        name: "FK_NoteSubjectTag_Notes_NoteId",
                        column: x => x.NoteId,
                        principalTable: "Notes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NoteSubjectTag_SubjectTags_SubjectTagId",
                        column: x => x.SubjectTagId,
                        principalTable: "SubjectTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostSubjectTag", x => new { x.PostId, x.SubjectTagId });
                    table.ForeignKey(
                        name: "FK_PostSubjectTag_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostSubjectTag_SubjectTags_SubjectTagId",
                        column: x => x.SubjectTagId,
                        principalTable: "SubjectTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListingSubjectTag_SubjectTagId",
                table: "ListingSubjectTag",
                column: "SubjectTagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteSubjectTag_SubjectTagId",
                table: "NoteSubjectTag",
                column: "SubjectTagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostSubjectTag_SubjectTagId",
                table: "PostSubjectTag",
                column: "SubjectTagId");
